...
class MMedia extends Model
{
    ...
    protected $allowedFields    = ['media_nama', 'media_user_id','media_type','media_path', 'media_slug'];
    ...
    {
        return $this->table('media')->like('media_nama', $keyword)->where('media_user_id', AuthUser()->id)->where('media_deleted_at', null)->orderBy('media_id', 'DESC');
    }
}
