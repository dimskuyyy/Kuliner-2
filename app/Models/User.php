...
class User extends Model
{
    ...
    protected $allowedFields    = ['user_nama', 'user_email', 'user_password', 'user_level', 'user_status', 'user_created_at', 'user_updated_at', 'user_updated_by', 'user_deleted_at', 'user_deleted_by'];
    ...
    protected $validationRulesCreate = [
        ...
        'user_email' => [
            'label' => 'Email',
            'rules' => 'required|valid_email|max_length[255]|is_unique[user.user_email]',
        ],
        'user_password' => [
            'label' => 'Password',
            'rules' => 'required|string|max_length[255]',
    ...
    public function setValidationRulesUpdate($userId)
    {
        $this->validationRulesUpdate = [
            ...
            'user_email' => [
                'label' => 'Email',
                'rules' => "required|string|max_length[255]|is_unique[user.user_email,user_id,{$userId}]",
            ],
            'user_level' => [
                'label' => 'Level',
                'rules' => 'required|integer|in_list[1,2,3]',
