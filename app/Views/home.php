...
<div id="sb-dynamic-content" class="sb-transition-fade">
        ...
        <div class="container">
            ...
            <div class="row">
                <?php foreach (\App\Enums\TipeKuliner::cases() as $tipe): ?>
                    <?php if ($tipe === \App\Enums\TipeKuliner::SEMUA) continue; ?>
                    <div class="col-lg-6">
                        <a href="<?= route_to('front.kuliner.kategori', $tipe->value) ?>" class="sb-categorie-card sb-categorie-card-2 sb-mb-30">
                            <div class="sb-card-body">
                                <div class="sb-category-icon">
                                    <img src="<?= base_url() ?>front/img/categories/1.png" alt="icon">
                                </div>
                                <div class="sb-card-descr">
                                    <h3 class="sb-mb-10"><?= $tipe->label() ?></h3>
        ...
        <div class="container">
            <div class="sb-group-title sb-mb-30">
                ...
                <div class="sb-right sb-mb-30">
                    ...
                    <!-- button -->
                    <a href="<?= route_to('front.kuliner.index') ?>" class="sb-btn">
                        <span class="sb-icon">
                            <img src="<?= base_url() ?>front/img/ui/icons/menu.svg" alt="icon">
                        </span>
                        <span>Full list</span>
            ...
            <div class="swiper-container sb-short-menu-slider-4i">
                <div class="swiper-wrapper">
                    <?php foreach ($topKuliner->getResult() as $kuliner): ?>
                        <div class="swiper-slide">
                            <a data-no-swup href="<?= route_to('front.kuliner.detail', $kuliner->slug_kuliner) ?>" class="sb-menu-item">
                                ...
                                <div class="sb-description">
                                    <p class="sb-text sb-mb-15"><?= $kuliner->excerpt ?>...</p>
                                    <!-- <ul class="sb-stars">
    ...
    <section class="sb-p-0-60">
        <div class="container">
            ...
            <div class="row">
                <?php foreach ($topPost->getResult() as $post): ?>
                    <div class="col-lg-3">
                        <div class="sb-team-member sb-mb-30">
                            <div class="sb-photo-frame sb-mb-15">
                                <img src="<?= route_to('media', $post->media_slug) ?>" alt="<?= $post->media_nama ?>" style="object-fit: cover;">
                            </div>
                            <div class="sb-member-description">
                                <h4 class="sb-mb-10"><?= $post->judul ?></h4>
                                <p class="sb-text sb-text-sm sb-mb-10"><?= $post->nama_kuliner ?></p>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
    ...
    <div class="sb-map-frame">
        <div id="kuliner-map" class="sb-map"></div>
...
<script>
    $(function() {
        ...
        // 0.5089843487297392, 101.44941233280007
        const map = L.map('kuliner-map').setView([0.5089843487297392, 101.44941233280007], 12); // Example: Centered on Pekanbaru
