    ...
    <div class="col-md-4">
        <div class="box box-widget">
            <div class="box-header ui-sortable-handle" style="cursor: move;">
                <h3 class="box-title"><b>Form Tambah/Edit Galeri</b></h3>
            </div>
            <div class="box-body">
                <?php
                ...
                <div class="form-group">
                    ...
                    <div class="choose-media">
                        <a href="#" class="btn btn-sm btn-flat btn-primary btn-media" data-backdrop="static"><i class="fa fa-plus"></i> Unggah Foto Galeri Kuliner <span id="text-optional"></span></a>
    ...
    <div class="col-md-8">
        <div class="box box-widget">
            <div class="box-header" style="cursor: move;">
                <h3 class="box-title"><b>List Galeri</b></h3>
            </div>
            <div class="box-body">
                    ...
                    <ol class="dd-list">
                        ...
                        if (isset($galeri) > 0) {
                            foreach ($galeri as $dt) { ?>
                                <li class="dd-item dd3-item" data-id="<?php echo $dt['galeri_id']; ?>" style="border:0px solid red;">
                                    <div class=" dd3-content" style="flex-direction: column; justify-content: flex-start; height: max-content; overflow: hidden;">
                                        <img src="<?= base_url('media/') . $dt['media_slug'] ?>" alt="<?= $dt['judul'] ?>" style="width:100%; height:200px; object-fit:cover;" class="dd-handle dd3-handle">
                                        <div style="width: 100%;padding:4px 6px">
                                            <?php echo $dt['judul'] ?>
                                            <div class="pull-right btn-list">
                                                <button type="button" data-id="<?php echo $dt['galeri_id']; ?>" class="btn btn-flat btn-xs btn-primary btn-edit" title="klik untuk edit galeri">
                                                    <i class="fa fa-edit"></i>
                                                </button>
                                                <button type="button" data-id="<?php echo $dt['galeri_id']; ?>" class="btn btn-flat btn-xs btn-danger btn-delete" title="klik untuk hapus galeri">
                                                    <i class="fa fa-trash"></i>
                                                </button>
                                            </div>
                                            <div class="collapse" id="form-galeri<?php echo $dt['galeri_id'] ?>">
                                                <div class="well">
                                                    FORM
                                                </div>
                                            </div>
...
<script>
    $(document).ready(function() {
        ...
        function setform(data) {
            ...
            form.find('input[name=\'judul\']').val(data.galeri);
