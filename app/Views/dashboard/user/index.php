        ...
        'columns': [{
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    if(data.level == 1){
                        return '<span class=\'label label-primary\'>SuperAdmin</label>'
                    }else if(data.level == 2){
                        return '<span class=\'label label-info\'>Member</label>'
                    }else if(data.level == 3){
                        return '<span class=\'label label-warning\'>Normal User</label>'
                    }
                }
            },
            {
