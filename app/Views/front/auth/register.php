...
<div class="register-container">
    ...
    <div class="register-right">
        <form id="register-form" class="register-form">
            ...
            <p class="mb-4">Apakah anda sudah memiliki akun? <a href="<?= route_to('front.auth.login') ?>"><strong style="text-decoration: underline;">Masuk</strong></a></p>
            <!-- Username Field -->
            <div class="mb-3">
                <label for="username" class="form-label">Nama</label>
                <input type="text" class="form-control py-4" id="username" name="username" placeholder="Enter your username" required>
            </div>
            <!-- Email Field -->
            <div class="mb-3">
...
<script>
    $(function () {
        $('#register-form').on('submit', function (event) {
            ...
            setLoadingBtn(btn);
            $.ajax({
                url: '<?= route_to('front.auth.storeUser'); ?>',
                type: 'post',
                dataType: 'json',
                data: form.serialize(),
